...
import {  cancelActionRequestDevice } from "@/api/licenses";
...
const DeviceCancelActionRequestModal = ({
  record,
  endModal,
  setRecord,
}: {
  ...
  const handleClick = async () => {
    try {
      const response = await cancelActionRequestDevice(record);
...
export default memo(DeviceCancelActionRequestModal);
