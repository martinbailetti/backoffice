...
import { validateDevice } from "@/api/licenses";
...
const DeviceValidateModal = ({
  ...
  const handleClick = async () => {
    try {
      const response = await validateDevice(record);
...
export default memo(DeviceValidateModal);
