...
import filters from "@/config/pages/validations/owner_validation_report/filters";
import table from "@/config/pages/validations/owner_validation_report/table";
import page from "@/config/pages/validations/owner_validation_report/index";
...
export const OwnersValidationReport = () => {
...
export default OwnersValidationReport;
