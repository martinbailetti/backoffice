...
import { rowActions } from "@/config/pages/validations/validation_rules/actions";
import table from "@/config/pages/validations/validation_rules/table";
import page from "@/config/pages/validations/validation_rules/index";
