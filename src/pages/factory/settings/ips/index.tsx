...
import { rowActions } from "@/config/pages/factory/settings/ips/actions";
import table from "@/config/pages/factory/settings/ips/table";
import page from "@/config/pages/factory/settings/ips/index";
