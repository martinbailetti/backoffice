...
import page from "@/config/pages/spv/settings/clients/edit";
...
import { getSpvClient, updateSpvClient } from "@/api/spv";
...
const SpvClientEdit = () => {
  ...
  useEffect(() => {
    ...
    const preparePage = async () => {
      ...
      try {
        const response = await getSpvClient({ id: id });
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await updateSpvClient(recordCurrent);
