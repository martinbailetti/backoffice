...
import { rowActions } from "@/config/pages/spv/settings/clients/actions";
import table from "@/config/pages/spv/settings/clients/table";
import page from "@/config/pages/spv/settings/clients/index";
